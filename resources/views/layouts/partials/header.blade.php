        ...
        <div class="mt-6 h-0 flex-1 flex flex-col overflow-y-auto">
            <div class="px-3 mt-5">
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <form id="searchform" name="searchform" action="{{route('home')}}">
                        <input type="text" class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-9 p-2 sm:text-sm border-gray-300 rounded-md"
                               placeholder="Search" name="name" onkeyup="ajaxSearch(event,0)"
                               id="search_form" >
                    </form>
                </div>
            </div>
